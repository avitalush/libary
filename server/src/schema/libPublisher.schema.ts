...
export const createPublisherSchema = z.object({
  body: z.object({
    ...
    address: z.string().min(1, { message: "Address must be greater than 1 character!" }),
...
export const updatePublisherSchema = z.object({
  ...
  body: z.object({
    ...
    address: z.string().min(1, { message: "Address must be greater than 1 character!" }).optional(),
